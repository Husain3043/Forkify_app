...
console.log(
  `The bill 1 was ${bill1}, the tip 1 was ${
    tipPercent1 * bill1
  } and the total value 1 ${bill1 + tipPercent1 * bill1}.`
);
console.log(
  `The bill 2 was ${bill2}, the tip 2 was ${
    tipPercent2 * bill2
  } and the total value 2 ${bill2 + tipPercent2 * bill2}.`
);
console.log(
  `The bill 3 was ${bill3}, the tip 3 was ${
    tipPercent3 * bill3
  } and the total value 3 ${bill3 + tipPercent3 * bill3}.`
);
...
console.log(
  "Avg function with array as argument, bill avg result : " +
    calAvgArr(billValues)
);
